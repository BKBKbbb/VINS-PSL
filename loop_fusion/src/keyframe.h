...
class KeyFrame {
public:
  static std::shared_ptr<KeyFrame>
  create(double _time_stamp, int _index, Vector3d &_vio_T_w_i,
         ...
         vector<XDescType> &_point_xdesc, VladType &_vlad_desc, int _sequence);
  KeyFrame();
